...
package com.example.ahmadsyam.useCase.detectText
...
import com.example.ahmadsyam.useCase.detectText.DetectTextActivity.Companion.DESIRED_HEIGHT_CROP_PERCENT
import com.example.ahmadsyam.useCase.detectText.DetectTextActivity.Companion.DESIRED_WIDTH_CROP_PERCENT
import com.example.ahmadsyam.util.Language
import com.example.ahmadsyam.util.ResultOrError
import com.example.ahmadsyam.util.SmoothedMutableLiveData

class DetectTextModel(application: Application) : AndroidViewModel(application) {
